    ...
    return (
        ...
        <div id="menu-icons" className="row fixed-top">
            <div className='btn' onClick={() => showModal()}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#b59f3b" className="bi bi-gear" viewBox="0 0 16 16">
        ...
        <div className={`modal ${doShowModal ? 'd-block' : 'd-none'}`}>
            <div className="modal-main">
                ...
                <div className='container'>
                    ...
                    <div class="btn btn-primary" onClick={() => hideModal()}>
                        Close Menu
                    </div>
                </div>
